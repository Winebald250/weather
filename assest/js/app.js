        ...
        fetchData(url.airPollution(lat, lon), (airPollution) => {
            ...
            card.innerHTML = `
                ...
                <div class="highlight-list">
                    ...
                    <!-- Other highlights like Sunrise & Sunset, Humidity, Pressure, etc. -->
                </div>
            `;
        ...
        fetchData(url.forecast(lat, lon), (forecast) => {
            ...
            for (const [index, data] of forecastList.entries()) {
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        <p class="body-3">${module.getTime(dateTimeUnix, timezone)}</p>
                        <img src="./assets/images/direction.png" width="48" height="48" alt="" class="weather-icon" style="transform: rotate(${windDirection - 180}deg)">
            ...
            // 5-DAY FORECAST
            forecastSection.innerHTML = `
                <h2 class="title-2" id="forecast-label" tabindex="0">5-Day Forecast</h2>
            ...
            for (let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                const dayOfWeek = date.getDay();  // Get local day of the week
                ...
                li.innerHTML = `
                    ...
                    <p class="label-1">${module.weekDayNames[dayOfWeek]}</p> <!-- Correct day display -->
                `;
